...
const step = ref(0)
const steps = [
  { icon: '🎓', title: '欢迎使用专升本学习助手', desc: '记录每日学习、追踪进度、游戏化激励，陪你高效备考上岸！' },
  { icon: '📐', title: '科目模块', desc: '高数、英语内置考纲章节，支持记录学习、刷题、掌握度评估，还能自定义扩展科目。' },
  { icon: '🍅', title: '番茄专注', desc: '25分钟番茄钟 + 白噪音，帮你保持专注，统计每日专注时长。' },
  { icon: '🏆', title: '成就激励', desc: '打卡得积分、升级段位、解锁徽章，连续学习天数见证你的坚持！' }
]
