  ...
  <Teleport to="body">
    <Transition name="fade">
      ...
      >
        ...
        />
        <button
          class="absolute top-4 right-4 w-9 h-9 rounded-full bg-white/15 text-white text-xl leading-none hover:bg-white/25"
          @click="close"
          aria-label="关闭"
        >
          ×
        </button>
        <div v-if="scale > 1" class="absolute top-4 left-4 text-white/60 text-xs">
