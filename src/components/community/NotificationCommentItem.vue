...
<template>
  <div
    class="w-full flex items-start gap-3 px-4 py-3 text-left transition-colors hover:bg-slate-50 dark:hover:bg-slate-700/40 cursor-pointer"
    @click="openComment"
  >
    ...
    <div class="flex-1 min-w-0">
      ...
      <p v-if="n.commentContent" class="text-sm text-slate-600 dark:text-slate-300 mt-1 leading-relaxed break-words">
        {{ n.commentContent }}
      </p>
