...
<template>
  <img
    ...
    :class="size === 'sm' ? 'w-5 h-5' : 'w-9 h-9'"
    @error="failed = true"
  />
  <div
    v-else
    class="rounded-full bg-gradient-to-br from-primary-500 to-indigo-600 text-white font-bold flex items-center justify-center shrink-0 select-none"
